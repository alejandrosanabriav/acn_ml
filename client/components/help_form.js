    ...
    return (
      <form className="form" onSubmit={this.handleSubmit}>
        <div className="form-group">
          ...
          <div
            style={errorStyle}
            className={this.state.errors.email ? "form-error" : "hidden"}
          >
            campo obligatorio
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          <div
            style={errorStyle}
            className={this.state.errors.firstName ? "form-error" : "hidden"}
          >
            campo obligatorio
          </div>
        </div>
        <div className="form-group">
          ...
          <div
            style={errorStyle}
            className={this.state.errors.lastName ? "form-error" : "hidden"}
          >
            campo obligatorio
          </div>
        </div>
        <div className="form-group">
          ...
          <div
            style={errorStyle}
            className={this.state.errors.phone ? "form-error" : "hidden"}
          >
            campo obligatorio
          </div>
        </div>
        <button disabled={this.state.loading} onClick={this.handleSubmit}>
          Deseo Ayudar
        </button>
      </form>
    );
